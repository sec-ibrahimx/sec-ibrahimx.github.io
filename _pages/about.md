...
<div class="w-full max-w-2xl mx-auto px-4 sm:px-6 py-4 text-slate-200 font-sans antialiased">
  ...
  <div class="mb-8">
    <div class="flex items-center gap-2 mb-3.5 text-slate-200">
      ...
      <h2 class="text-lg font-bold m-0 p-0 tracking-normal text-slate-100">What You'll Find Here</h2>
    </div>

    <div class="space-y-3">
      <div class="bg-[#111827]/60 border border-slate-800 rounded-xl p-4 flex items-center justify-between">
        <div class="flex items-center gap-3.5">
          <div class="w-10 h-10 rounded-lg bg-slate-800/50 border border-slate-700/40 flex items-center justify-center text-slate-400 shrink-0">
            <i data-lucide="file-text" class="w-5 h-5"></i>
          </div>
          <div>
            <h3 class="text-base font-bold text-slate-100 m-0 mb-0.5 leading-snug">Research Digest</h3>
            <p class="text-sm text-slate-400 m-0 leading-relaxed">Breakdowns and critical reviews of emerging cybersecurity and AI security papers.</p>
          </div>
        </div>
      </div>
      ...
      <div class="bg-[#111827]/60 border border-slate-800 rounded-xl p-4 flex items-center justify-between">
        <div class="flex items-center gap-3.5">
          ...
          <div>
            <h3 class="text-base font-bold text-slate-100 m-0 mb-0.5 leading-snug">Technical Write-ups</h3>
            <p class="text-sm text-slate-400 m-0 leading-relaxed">Detailed analyses of security concepts, tools, and real-world scenarios.</p>
          </div>
        </div>
      </div>
    </div>
